...
<div id="navDemo" class="w3-hide w3-hide-large w3-hide-medium w3-top" style="margin-top:51px">
  <ul class="w3-navbar w3-left-align w3-large w3-theme">
    ...
    <li><a class="w3-padding-large" href="#"><i class="fa fa-user"></i> Account</a></li>
    ...
    <div class="w3-col m3">
      ...
      <div class="w3-card-2 w3-round">
        <div class="w3-accordion w3-white">
          <button onclick="myFunction('Demo1')" class="w3-btn-block w3-theme-l1 w3-left-align"><i class="fa fa-sign-in fa-fw w3-margin-right"></i> Follow <span class="w3-badge w3-green"><?php print $follow ?></span></button>
          ...
          <button onclick="myFunction('Demo2')" class="w3-btn-block w3-theme-l1 w3-left-align"><i class="fa fa-sign-out fa-fw w3-margin-right"></i> Follower <span class="w3-badge w3-blue"><?php print $follower ?></span></button>
          ...
          <button onclick="myFunction('Demo3')" class="w3-btn-block w3-theme-l1 w3-left-align"><i class="fa fa-users fa-fw w3-margin-right"></i> Le mie informazioni</button>
          <div id="Demo3" class="w3-accordion-content w3-container" style="text-align:center;">
         <div class="w3-row-padding w3-container" style="padding-left:0px;"><br>
			 <?php
				$sex = "Maschio";
				if($personal["sesso"]==0){
					$sex = "Femmina";	
				...
				print "</table>";
			?>
			 <br><button class="w3-btn w3-blue-grey" onclick="modify(<?php print '\''.$user.'\', \''.$personal["nome"].'\', \''.$personal["cognome"].'\', \''.$personal["data_nascita"].'\', \''.$personal["luogo_nascita"].'\', \''.$personal["citta_residenza"].'\', \''.$personal["nazionalita"].'\''?>)">Modifica</button><br><br>
         </div>
          </div>
        </div>      
      </div>
	  ...
	  <script>
      	function modify(mail, nome, cognome, data, luogo, citta, naz){
			document.getElementById('Demo3').innerHTML = '<div class="w3-row-padding w3-container" style="padding-left:0px;"><br>'+
				...
				'<tr><td><strong>Compleanno</strong></td><td><input name="data" class="w3-input" type="text" value="'+data+'"></td></tr>'+
...
<a href="#" target="_top" style="text-decoration:none;"><h4 id="nome_seguito_$id">$name</h4></a><br>
<hr class="w3-clear">
...
EOL;
				...
				$is_exp = pg_fetch_array(pg_query($conn, "SELECT mail FROM esperto WHERE mail='$row_mail'"))[0];
